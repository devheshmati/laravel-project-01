        ...
        <div class="row min-height-100vh">
            <div class="col-md-6 d-flex justify-content-center align-items-center">
                <form class="p-5 shadow">
                    ...
                    <div class="mb-4">
                        <label class="form-label" for="password-input">Set Password</label>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" id="password-input" placeholder="Repeat your password" class="form-control stext-111 cl2 plh3 size-116 p-l-62 p-r-30" />
                    </div>
                    <button type="submit" class="mb-4 btn btn-primary">Register</button>
                    <div>
                        <a class="btn-link" href="{{route('login')}}">Go to the login.</a>
                    </div>
                    <div class="mb-2">
